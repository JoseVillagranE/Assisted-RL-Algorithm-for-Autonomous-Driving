...
class CarlaEnv(gym.Env):
    ...
    def __init__(
        ...
        try:
            ...
            for exo_veh_ipos, exo_veh_epos, ed in zip(exo_vehs_ipos, exo_vehs_epos, exo_driving):
                ...
                exo_veh_end_location = carla.Location(
                    x=exo_veh_epos[0], y=exo_veh_epos[1], z=1
                )
    ...
    def step(self, action):
        ...
        for i, (exo_veh, ed) in enumerate(zip(self.exo_vehs, self.exo_driving)):
            if ed:
                ...
                if not exo_veh.autopilot_mode and self.exo_driving[i]:
    ...
    def reset(self,
        ...
        assert len(self.exo_vehs) == len(exo_vehs_ipos) == len(exo_driving), f"exo_vehs: {len(self.exo_vehs)} || exo_vehs_ipos: {len(exo_vehs_ipos)} || exo_driving: {len(exo_driving)}"
